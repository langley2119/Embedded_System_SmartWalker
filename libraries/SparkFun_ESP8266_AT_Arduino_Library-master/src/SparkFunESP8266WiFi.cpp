...
{
	// get Access point refers to attempting to connnect to an access point. 
...
IPAddress ESP8266Class::localIP()
{
	...
	if (rsp > 0)
	{
		...
		// puts the pointer in the first string to the beginning of the found string 
...
//////////////////////////////////////
// WiFi Functions added by Jackson 	//
//////////////////////////////////////

/*
int16_t ESP8266Class::configureAP() {
	sendCommand(ESP8266_AP_CONFIG_CUR, ESP8266_CMD);
