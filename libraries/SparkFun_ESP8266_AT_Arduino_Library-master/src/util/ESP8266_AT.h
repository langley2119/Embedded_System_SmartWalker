...
const char ESP8266_AP_CONFIG_CUR[] = "+CWSAP_CUR" // sets the current softAP configuration (not saved to flash)
const char ESP8266_AP_CONFIG_DEF[] = "+CWSAP_DER" // sets the default softAP configuration (IS saved to flash)
//!const char ESP8266_STATION_IP[] = "+CWLIF"; // List station IP's connected to softAP
//!const char ESP8266_DHCP_EN[] = "+CWDHCP"; // Enable/disable DHCP (Dynamic Host Configuration Protocol)
